...
A small portion of that Question is true but if we want to have a better understanding, lets us dip even deeper. So its known that email uses secure **TLS** (**_transport layer security_**) to transmit data across the internet.
